...
Generated by [HoundDog.ai](https://hounddog.ai) on 2026-01-29 02:57:28 AM.
...
1. First detected here in [pages/1_Patient_Management.py:59:9](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L59-L59)

    ```python
    medical_history
    ```

2. Placed inside a string, propagated from receiver via str.strip and assigned to 'patient_context' in [pages/1_Patient_Management.py:284:17](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L284-L295)
...
3. Wrapped in langchain_core.messages.SystemMessage and assigned to 'messages' in [pages/1_Patient_Management.py:317:25](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L317-L317)

    ```python
    messages = [SystemMessage(content=patient_context)]
    ```

4. Exposed to OpenAI in [pages/1_Patient_Management.py:330:36](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L330-L330)
...
file_45_327b0e11e7f2e0a3078f064ed4ea403d("<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py'>pages/1_Patient_Management.py</a>")
style file_45_327b0e11e7f2e0a3078f064ed4ea403d fill:none,stroke:#808080,stroke-width:1px
de_45 --> file_45_327b0e11e7f2e0a3078f064ed4ea403d
file_45_327b0e11e7f2e0a3078f064ed4ea403d --> |<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L330-L330'>L330</a>| sink_openai
...
file_47_f3b82eca6148dc549059de4f35e70529 --> |<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/utils/data_manager.py#L389-L389'>L389</a>| sink_sql_db
sink_sql_db("<a href='#data-sink-sql-db'>SQL Database</a>")
style sink_sql_db fill:#00800026,stroke:#006400,color:#006400
...
1. First detected here in [pages/1_Patient_Management.py:101:33](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L101-L101)

    ```python
    "phone": phone
    ```

2. Placed inside a dictionary and exposed to Sentry in [pages/1_Patient_Management.py:98:21](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L98-L102)
...
file_60_327b0e11e7f2e0a3078f064ed4ea403d("<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py'>pages/1_Patient_Management.py</a>")
style file_60_327b0e11e7f2e0a3078f064ed4ea403d fill:none,stroke:#808080,stroke-width:1px
de_60 --> file_60_327b0e11e7f2e0a3078f064ed4ea403d
file_60_327b0e11e7f2e0a3078f064ed4ea403d --> |<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L98-L102'>L98</a>| sink_sentry
...
**Sensitivity:** 🟡 Low • **Tags:** PII • **Occurrences:** 92
...
in [pages/1_Patient_Management.py:330:36](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L330-L330):
...
in [pages/1_Patient_Management.py:98:21](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/1_Patient_Management.py#L98-L102):
...
<span style="color:rgba(100, 100, 100, 1); font-size: 0.85em;">Use `--all-dataflows` flag to include safe dataflows in the report.</span>

...
Generated by [HoundDog.ai](https://hounddog.ai) on 2026-01-29 03:50:02 AM.
...
- [Sensitive Datamap](#sensitive-data-map)
...
|Parameter|Value|
|:-|:-|
|Scanner Version|2.4.0|
|Scanner Build|b616f371e7c3b5b9f3420ff1cabd220411c6266f|
...
<span style="color:rgba(100, 100, 100, 1)">*None*</span>
...
2. placed inside a string in [pages/patient.py:284:35](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L284-L286)
...
3. assigned to 'patient_context' in [pages/patient.py:284:17](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L284-L286)
...
4. wrapped in langchain_core.messages.SystemMessage in [pages/patient.py:308:37](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L308-L308)

    ```python
    SystemMessage(content=patient_context)
    ```

5. assigned to 'messages' in [pages/patient.py:308:25](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L308-L308)

    ```python
    messages = [SystemMessage(content=patient_context)]
    ```

6. exposed to OpenAI in [pages/patient.py:321:36](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L321-L321)
...
file_47_f3b82eca6148dc549059de4f35e70529 --> |<a href='https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/utils/data_manager.py#L387-L387'>L387</a>| sink_sql_db
sink_sql_db("<a href='#data-sink-sql-db'>SQL Database</a>")
style sink_sql_db fill:#00800026,stroke:#006400,color:#006400
...
2. placed inside a dictionary in [pages/patient.py:101:33](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L101-L101)

    ```python
    "phone": phone
    ```

3. exposed to Sentry in [pages/patient.py:98:21](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/pages/patient.py#L98-L102)
...
**Sensitivity:** 🟠 Medium • **Tags:** PII • **Occurrences:** 154
...
2. placed inside a string in [scripts/seed_db.py:168:26](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/scripts/seed_db.py#L168-L168)

    ```python
    f"Added patient: {first_name} {last_name}"
    ```

3. exposed to Logs in [scripts/seed_db.py:168:13](https://github.com/hounddogai/hounddog-test-python-app/blob/781c916790f5/scripts/seed_db.py#L168-L168)
...
This section shows the paths that sensitive data takes through the codebase to reach data sinks.
...
This issue was rated as 🟥 **CRITICAL** for exposing the following to [OpenAI](#data-sink-openai):
...
This issue was rated as 🟧 **MEDIUM** for exposing the following to [Sentry](#data-sink-sentry):
...
This issue was rated as 🟨 **LOW** for exposing the following to [Logs](#data-sink-logs):

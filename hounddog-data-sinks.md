...
Generated: 2026-01-27 01:06:41

🟩 Supported 🟨 Partially Supported 🟥 Not Supported Yet ⬜ Not Applicable

| Data Sink                                                   | Python | TypeScript | Java | C#/.NET | Go |
|-------------------------------------------------------------|--------|------------|------|---------|----|
| Adyen                                                       | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| AgentMail                                                   | 🟩     | 🟩         | ⬜    | ⬜       | ⬜  |
| Anthropic                                                   | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
...
| Google Cloud Enterprise Knowledge Graph API                 | 🟩     | 🟥         | 🟩   | 🟩      | 🟥 |
...
| Google Cloud GDC Hardware Management                        | 🟩     | 🟥         | 🟥   | 🟥      | 🟥 |
| Google Cloud Gemini Data Analytics                          | 🟩     | 🟩         | 🟥   | 🟩      | 🟩 |
| Google Cloud GKE                                            | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Grafeas                                        | 🟩     | 🟩         | 🟥   | 🟩      | 🟩 |
| Google Cloud HTTP Replay                                    | 🟥     | 🟥         | 🟥   | 🟥      | 🟩 |
| Google Cloud Hypercompute Cluster                           | 🟩     | 🟥         | 🟥   | 🟥      | 🟥 |
| Google Cloud IAM Policy Simulator                           | 🟩     | 🟥         | 🟥   | 🟥      | 🟩 |
...
| Google Cloud Quotas                                         | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Rapid Migration Assessment                     | 🟩     | 🟥         | 🟥   | 🟥      | 🟩 |
| Google Cloud reCAPTCHA Enterprise                           | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Recommendations AI                             | 🟩     | 🟥         | 🟥   | 🟩      | 🟩 |
| Google Cloud Recommender                                    | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Resource Manager                               | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Retail API                                     | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud RPC Replay                                     | 🟥     | 🟥         | 🟥   | 🟥      | 🟩 |
| Google Cloud Run                                            | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud SaaS Platform SaaS Service Management          | 🟩     | 🟥         | 🟥   | 🟩      | 🟥 |
...
| Google Cloud Shell                                          | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Shopping API                                   | 🟩     | 🟩         | 🟥   | 🟩      | 🟩 |
| Google Cloud Source Context                                 | 🟩     | 🟥         | 🟥   | 🟥      | 🟥 |
| Google Cloud Spanner                                        | 🟥     | 🟩         | 🟩   | 🟩      | 🟨 |
| Google Cloud Speech-to-Text                                 | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Storage                                        | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Street View Publish API                        | 🟥     | 🟥         | 🟥   | 🟥      | 🟩 |
| Google Cloud Talent Solution                                | 🟩     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Tasks                                          | 🟥     | 🟩         | 🟩   | 🟩      | 🟩 |
| Google Cloud Tasks                                          | 🟩     | 🟥         | 🟥   | 🟥      | 🟥 |
| Google Cloud Telco Automation                               | 🟩     | 🟥         | 🟥   | 🟥      | 🟩 |
